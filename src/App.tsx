...
function HomeView({ ctx }: { ctx: any }) {
  ...
  async function handleSignIn() {
    ...
    try {
      ...
      push({ type:"success", title:"Signed in", msg:`FID ${data.fid}` });
      const u = await apiJson<UserCard>(`/api/score?fid=${data.fid}`);
      setMe(u);
    } catch (e:any) {
      push({ type:"error", title:"Sign-in failed", msg: String(e?.message || e) });
    } finally {
      setLoading(false);
    }
  }
  ...
  async function handleSearch() {
    const q = query.trim();
    if (!q) {
      push({ type:"warning", title:"Enter @handle or FID", msg:"Examples: @dwr, 3" });
      return;
    }
    setLoading(true);
    try {
      ...
      push({ type:"error", title:"Lookup failed", msg:String(e?.message || e) });
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <div className="container">
      <div className="card">
        <div className="header">
          <div className="brand">
            ...
            <div>
              ...
              <div className="sub">Mini App • Snapshot-based score history</div>
            </div>
          </div>
          <div className="row">
        ...
        <div className="section">
          ...
          <div className="row" style={{ alignItems:"flex-end", justifyContent:"space-between" }}>
            <div className="kv">
              <div className="k">Your latest known Neynar score</div>
              <div className="v">{formatScore(me?.score ?? null)}</div>
              <div className="sub">
          ...
          <div className="spacer" />
          <div className="card" style={{ boxShadow:"none", borderRadius:16, background:"var(--surface)", border:"1px solid var(--border)" }}>
            <div className="section">
      ...
      <div className="spacer" />
      <div className="sub">
        This Mini App is designed to run inside a Farcaster client (Mini App chrome). If you see a browser URL bar, you are not in the required Mini App environment.
      </div>
    </div>
  );
}
...
function UserView({ fid }: { fid: number }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        if (cancelled) return;
        push({ type:"error", title:"Failed to load user", msg:String(e?.message || e) });
      } finally {
  ...
  async function toggleTrack() {
    ...
    try {
      ...
      push({ type:"error", title:"Couldn't enable tracking", msg:String(e?.message || e) });
    } finally {
      setTracking(false);
    }
  }
        ...
        <div className="section">
          ...
          <div className="grid">
            <div className="card" style={{ boxShadow:"none" }}>
              <div className="section">
                ...
                <div className="sub" style={{ marginTop: 6 }}>Line graph + table alternative below.</div>
            ...
            <div className="card" style={{ boxShadow:"none" }}>
              <div className="section">
                ...
                <div className="sub" style={{ marginTop: 6 }}>Only entries where score changed vs previous snapshot.</div>
                <div className="spacer" />
                {changes.length ? (
          ...
          <div className="card" style={{ boxShadow:"none" }}>
            <div className="section">
              ...
              <div className="sub" style={{ marginTop: 6 }}>
                Timestamp, score, and change vs previous snapshot.
              </div>
              <div className="spacer" />
