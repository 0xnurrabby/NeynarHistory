  ...
  if (!inMini) {
    ...
    return (
      <div className="min-h-screen px-5 py-10">
        <div className="mx-auto max-w-md rounded-3xl border border-white/15 bg-white/10 p-6">
          <div className="text-lg font-semibold">Open in a Farcaster client</div>
          <div className="mt-2 text-sm text-white/70 dark:text-white/70 text-gray-600">
